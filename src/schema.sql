...
-- v0.42 Calendar Projection — EventKit/macOS collector snapshot ->
-- BrainEngine ledger/receipts -> generated default:sources/calendar pages.
...
BEGIN
  ...
  IF has_bypass THEN
    ...
    -- v0.42 Calendar Projection provider-neutral ledger tables
    ALTER TABLE calendar_provider_records ENABLE ROW LEVEL SECURITY;
    ALTER TABLE calendar_day_ledger ENABLE ROW LEVEL SECURITY;
    ALTER TABLE calendar_projection_receipts ENABLE ROW LEVEL SECURITY;
    ALTER TABLE calendar_provider_cursors ENABLE ROW LEVEL SECURITY;
