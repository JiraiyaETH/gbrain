...
PINNED_SKILL_SHA256 = "54948fd74bd87a453ec35d90bc52e6d9a99362bfd697ceb0eb3566c30c89fe41"
...
PINNED_FILING_RULES_SHA256 = "3f6231b184f777ceccfe3cdbfb0fb569c1a5df903743b2bd249bf160314e414c"
PINNED_FILING_RULES_JSON_SHA256 = "6a70ed46950994405706ebe18ca2f72039e428ce4c14ad7bf9323a6b1c52f1e7"
...
def isolated_agent_workspace():
    ...
    with tempfile.TemporaryDirectory(prefix="meeting-agent-", dir=str(parent)) as raw_root:
        ...
        # SKILL_DIR defaults to a subdir of RUNTIME_SKILLS_DIR, which the
        # wholesale copy above already materialized (read-only, so an
        # overwrite would EACCES). Copy separately only for an external
        # MEETING_INGESTION_SKILL_DIR override.
        if not sandbox_skill.exists():
