...
export MEETING_INGESTION_SKILL_DIR="${MEETING_INGESTION_SKILL_DIR:-$SCRIPT_DIR/meeting-ingestion}"
export MEETING_QA_SCRIPT="${MEETING_QA_SCRIPT:-$SCRIPT_DIR/meeting-ingestion/scripts/qa-meeting.sh}"
