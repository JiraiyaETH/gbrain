...
# (2026-07-22: the meeting sandbox controller and its checksum pins are
# retired — the thin runner reads the LIVE skill tree. The skills payload
# below still ships for the dream + enrich lanes, which read sealed copies.)
