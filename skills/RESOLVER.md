...
| "track", "structured data research", "extract from email", "investor updates", "donations", source table / structured extraction | `skills/data-research/SKILL.md` |
...
| "consortium form", "operator friendly", "operator tab", "net status", "consortium member", "consortium vendor", "consortium operator", "consortium outreach", "form sent", "form filled" | `skills/consortium-operator-tracker/SKILL.md` |
...
| Trigger | Skill |
|---------|-------|
| "personalized version of this book", "mirror this book", "two-column book analysis", "apply this book to my life", "how does this book apply to me", chapter-by-chapter personal mapping | `skills/book-mirror/SKILL.md` |
| "enrich this article", "batch enrich", "batch enrich pass", "unstructured articles", "enrich articles", "enrich article dumps", "raw content but no executive summary", "make brain pages useful", "make article pages useful" | `skills/article-enrichment/SKILL.md` |
| "strategic reading", "read this through the lens of", "apply this to my problem", "extract a playbook from this case study", "what can I learn from this", hostile gatekeeper / launch lesson extraction | `skills/strategic-reading/SKILL.md` |
| "concept synthesis", "synthesize my concepts", "intellectual map", "patterns across my notes", "idea evolution", canon vs riff | `skills/concept-synthesis/SKILL.md` |
| "verify this academic claim", "academic verify", "check this study", "validate citation", "replicated", "Retraction Watch", trace research claim to source data | `skills/academic-verify/SKILL.md` |
| "crawl my archive", "archive crawler", "scan my Dropbox", "old files", "old letters", "journal entries", archive mining | `skills/archive-crawler/SKILL.md` |
| "perplexity research", "web research pass", "what's new about", "current state of", "what changed", "what changed about", "what changed since I last looked", web research delta, funding-round update | `skills/perplexity-research/SKILL.md` |
| "make pdf from brain", "brain pdf", "convert brain page to pdf", "export brain page to pdf", "clean PDF", "publish this page as pdf", printable brain-page deliverable | `skills/brain-pdf/SKILL.md` |
| "voice note", "voice memo", "audio note", "audio message", "transcribe and file", "save this audio note" | `skills/voice-note-ingest/SKILL.md` |
| "process this book", "ingest this PDF book", "summarize this book", "video/audio/PDF/book/YouTube/screenshot" | `skills/media-ingest/SKILL.md` |
